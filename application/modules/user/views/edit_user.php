				   ...
				   <hr>
				    <form method="post" action="user/update_user/<?=$users['id']?>">
					 <div class="form-group">
					  ...
					  <input type="text" name="name" class="form-control" id="input-1" value="<?php echo $users['name'] ?>">
					 </div>
					 <div class="form-group">
					  <label for="input-2">Email</label>
					  <input type="text" name="email" class="form-control" id="input-2" value="<?php echo $users['email']?>">
					 </div>
					 <div class="form-group">
